    ...
    <div class="max-w-5xl mx-auto ">
        ...
        @if($unreadCount == 0)
            ...
            <div class="flex flex-col justify-center items-center h-96 w-full">
                ...
                <svg class="w-12 h-12 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
