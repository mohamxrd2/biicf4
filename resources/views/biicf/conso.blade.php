...
@section('content')
    ...
    <div
        ...
        <div>
            <h1 class="bold" style="font-size: 24px;">Liste des Consommations</h1>
        </div>
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center">
                                        <div class="flex flex-col justify-center items-center h-72 w-full">
                                            ...
                                            <h1 class="text-xl text-gray-500 dark:text-gray-400">Aucune consommation</h1>
                                        </div>
                                    </td>
                                </tr>
                            @else
                                @foreach ($consommations as $consommation)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <p class="mb-0">{{ $consommation->type }}</p>
                                        </td>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="absolute top-2 end-2">
                                                            <button type="button"
                                                                ...
                                                                data-hs-overlay="#hs-delete-{{ $consommation->id }}">
                                                        ...
                                                        <div class="p-4 sm:p-10 text-center overflow-y-auto">
                                                            ...
                                                            <p class="text-gray-500 dark:text-neutral-500">
                                                                Vous etes sur de supprimé le consommation ?
                                                            </p>

                                                            <div class="mt-6 flex justify-center gap-x-4">
                                                                <form
                                                                    action="{{ route('biicf.consodelete', $consommation->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                        ...
                                        <td class="px-6 py-4">
                                            <p class="mb-0">
                                                {{ \Carbon\Carbon::parse($consommation->created_at)->diffForHumans() }}
                                            </p>
                                        </td>
