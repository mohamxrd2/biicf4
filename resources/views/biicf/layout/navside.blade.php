...
<head>
    ...
    <link rel="preload" href="/build/assets/app-BqjtQzdG.css" as="style">
    <link rel="preload" href="/build/assets/app-BdfuUhY1.css" as="style">

    <!-- Préchargement des fichiers JavaScript -->
    <link rel="preload" href="/build/assets/app-BoBUaGGS.js" as="script">

    <!-- Chargement standard des CSS (nécessaire pour les appliquer) -->
    <link rel="stylesheet" href="/build/assets/app-BqjtQzdG.css">
    <link rel="stylesheet" href="/build/assets/app-BdfuUhY1.css">
...
<body class="bg-gray-100">
    ...
    <div id="application-sidebar"
        ...
        <div class="px-6">
            <a id="logo" class="flex-none text-xl font-semibold dark:text-white"
