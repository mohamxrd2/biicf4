...
<body class="bg-gray-100">
    ...
    <div id="application-sidebar"
        ...
        <div class="px-6">
            ...
            <button onclick="toggleSidebar()" class="text-yellow-500 text-2xl">
                &laquo;
            </button>
        </div>
    ...
    <script>
        function toggleSidebar() {
            ...
            if (sidebar.classList.contains('w-28')) {
                ...
                // Appliquer une marge à gauche à l'input
                input.style.marginLeft = '8rem';
            } else {
                content.classList.add('lg:ps-72');
                content.classList.remove('lg:ps-32');

                // Remettre la marge à sa valeur initiale (ou la supprimer)
