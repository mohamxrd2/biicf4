...
<body class="bg-gray-100">
    ...
    <script>
        Livewire.on('priceSubmitted', (data) => {
            console.log('New price submitted:', data);
            Toastify({
                text: `Nouvelle offre soumise pour le produit ${data.idProd}`,
                duration: 3000,
                gravity: 'top', // Position de la notification: top ou bottom
                position: 'right', // Position de la notification: left, center ou right
                style: {
                    background: 'linear-gradient(to right, #00b09b, #96c93d)' // Nouvelle manière
                }
            }).showToast();
            // Mettre à jour l'interface utilisateur en temps réel
            // Par exemple, vous pouvez afficher une notification ou mettre à jour une liste
