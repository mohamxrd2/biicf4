...
<div id="medium-offre{{ $produit->id }}" wire:ignore.self tabindex="-1"
    ...
    <div class="relative w-full max-w-lg max-h-full mx-auto mt-10">
        <div class="relative bg-white rounded-xl shadow-2xl transform transition-all dark:bg-gray-800">
            <div class="flex items-center justify-between p-6 border-b dark:border-gray-700">
                ...
                <x-modal.close-button modal-id="medium-offre{{ $produit->id }}" />
            </div>
                ...
                <div class="mb-6">
                    <x-offre.nombre-clients :nombre="$nombreProprietaires" />
                        ...
                        <x-offre.zone-select />
                                                ...
                                                <x-offre.form-buttons :modal-id="'medium-offre' . $produit->id"
