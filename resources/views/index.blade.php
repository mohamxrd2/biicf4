...
<body class="font-sans antialiased" x-data="{ isOpen: false, scrolled: false }" @scroll.window="scrolled = window.pageYOffset > 20">
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-3" data-aos="fade-right">
                    <div class="relative group">
                        <div
                            class="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-1000 group-hover:duration-200">
                        </div>
                ...
                <div class="hidden md:flex items-center space-x-8" data-aos="fade-left">
                    ...
                    <a href="{{ route('biicf.login') }}" class="relative inline-flex group">
                        <div
                            class="absolute transitiona-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 rounded-xl blur-lg group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200">
                        </div>
                        <button
                            class="relative inline-flex items-center justify-center px-6 py-2 text-lg font-medium text-white transition-all duration-200 bg-black rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">
                            Connexion
                        </button>
                    </a>
                </div>
            ...
            <div class="md:hidden" x-show="isOpen" x-transition:enter="transition ease-out duration-200"
                ...
                <div class="px-2 pt-2 pb-3 flex flex-col space-y-2">
                    ...
                    <a href="{{ route('biicf.login') }}"
                        class="mobile-nav-link hover:bg-gray-200 rounded-md p-2">Connexion</a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('biicf.login') }}"
                            class="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-white bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl hover:from-purple-700 hover:to-pink-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                            Démarrer maintenant
                        ...
                        <a href="#"
                            class="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-purple-600 bg-white rounded-xl border-2 border-purple-600/10 hover:bg-purple-50 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                            En savoir plus
                        </a>
                    </div>
                </div>
                <div class="relative" data-aos="fade-left" data-aos-delay="400">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-3xl blur-3xl transform rotate-6">
                    </div>
                    <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2074&q=80"
                        alt="Business Growth" class="relative rounded-3xl shadow-2xl">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="feature-card" data-aos="fade-up" data-aos-delay="100">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl flex items-center justify-center text-white mb-6">
                ...
                <form class="feature-card" data-aos="fade-left">
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text"
                                class="mt-1 block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea rows="4"
                                class="mt-1 block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200"></textarea>
                        </div>
                        <button type="submit"
                            class="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-xl hover:from-purple-700 hover:to-pink-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                            Envoyer le message
                        </button>
                    </div>
                </form>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="100">
                    ...
                    <ul class="mt-4 space-y-3">
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Marketplace
                                B2B</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Solutions
                                Financières</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Consulting
                                Digital</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Formation</a>
                        </li>
                    </ul>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul class="mt-4 space-y-3">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Partenaires</a>
                        </li>
                ...
                <div data-aos="fade-up" data-aos-delay="300">
                    ...
                    <ul class="mt-4 space-y-3">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Statut API</a>
                        </li>
            ...
            <div class="mt-12 pt-8 border-t border-gray-800">
                <div class="text-center">
                    ...
                    <div class="mt-4 flex justify-center space-x-6">
                        ...
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Conditions
                            d'utilisation</a>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Mentions
                            légales</a>
                    </div>
                </div>
            </div>
