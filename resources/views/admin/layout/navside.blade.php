                ...
                <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                    <ul class="space-y-1.5 ">
                        ...
                        <li class="hs-accordion @if (request()->route()->getName() == 'admin.produits' || request()->route()->getName() == 'admin.services') active @endif" id="account-accordion">
                            <button type="button"
                                class="hs-accordion-toggle hs-accordion-active:text-purple-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300 dark:hs-accordion-active:text-white">
                            ...
                            <div id="account-accordion"
                                ...
                                <ul class="pt-2 ps-2">
                                    <li>
                                        <a class="flex @if (request()->route()->getName() == 'admin.produits') bg-gray-100 text-purple-700 @endif items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-300"
                                            href="{{ route('admin.produits') }}">
                                            Produits
                                        </a>
                                    </li>
                                    <li>
                                        <a class="flex @if (request()->route()->getName() == 'admin.services') bg-gray-100 text-purple-700 @endif items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-300"
                    ...
                    <ul class="space-y-1.5 ">
                        ...
                        <li class="hs-accordion @if (request()->route()->getName() == 'admin.conso-produit' || request()->route()->getName() == 'admin.conso-service') active @endif" id="account-accordion">
                            ...
                            <div id="account-accordion"
                                ...
                                <ul class="pt-2 ps-2">
                                    <li>
                                        <a class="flex @if (request()->route()->getName() == 'admin.conso-produit') bg-gray-100 text-purple-700 @endif items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-300"
                                            href="{{ route('admin.conso-produit') }}">
                                            Produits
                                        </a>
                                    </li>
                                    <li>
                                        <a class="flex @if (request()->route()->getName() == 'admin.conso-service') bg-gray-100 text-purple-700 @endif items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-300"
                        ...
                        @include('admin.components.nav', [
                            'routeSelf' => 'admin.demande',
                            'route' => route('admin.demande'),
                        ...
                        @include('admin.components.nav', [
                            'routeSelf' => 'admin.projetlist',
                            'route' => route('admin.projetlist'),
                ...
                <div class="p-4 sm:p-10 text-center overflow-y-auto">
                    ...
                    <script>
                        document.getElementById("logout-button").addEventListener("click", function() {
                            window.location.href = "{{ route('biicf.login') }}";
                        });
                    </script>
