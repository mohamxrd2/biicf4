                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 p-3">
                            ...
                            <div>
                                ...
                                <select id="categorie" wire:model="categorie" required
                                    ...
                                    <option value="AGRICULTURE DESTINEE A L'INDUSTRIE OU A L'EXPORTATION">AGRICULTURE
                                        DESTINEE A
                                        L'INDUSTRIE OU A L'EXPORTATION</option>
                                    <option value="ELEVAGE ET CHASSE">ELEVAGE ET CHASSE</option>
                                    <option value="ACTIVITES ANNEXES A L'AGRICULTURE L'ELEVAGE ET LA CHASSE">ACTIVITES
                                        ANNEXES A
                                    ...
                                    <option value="EXTRACTION DE CHARBON ET DE LIGNITE">EXTRACTION DE CHARBON ET DE
                                        LIGNITE
                                    </option>
                                    <option value="EXTRACTION D'HYDROCARBURES">EXTRACTION D'HYDROCARBURES</option>
                                    <option value="EXTRACTION DE MINERAIS MÉTALLIQUES">EXTRACTION DE MINERAIS
                                        MÉTALLIQUES
                                    </option>
                                    <option value="EXTRACTION DE PIERRES DE SABLES ET D'ARGILES">EXTRACTION DE PIERRES
                                        DE
                                        SABLES
                                        ET
                                        D'ARGILES</option>
                                    <option value="ACTIVITES EXTRACTIVES N.C.A.">ACTIVITES EXTRACTIVES N.C.A.</option>
                                    <option value="ACTIVITES DE SOUTIEN A L’EXTRACTION D’HYDROCARBURES">ACTIVITES DE
                                        SOUTIEN
                                        A
                                        L’EXTRACTION D’HYDROCARBURES</option>
                                    <option value="ACTIVITES DE SOUTIEN AUX AUTRES INDUSTRIES EXTRACTIVES">ACTIVITES DE
                                        SOUTIEN
                                        AUX
                                        AUTRES INDUSTRIES EXTRACTIVES</option>
                                    <option value="ABATTAGE TRANSFORMATION ET CONSERVATION DE LA VIANDE">ABATTAGE
                                        TRANSFORMATION
                                        ET
                                    ...
                                    <option value="TRANSFORMATION ET CONSERVATION DE FRUITS ET LEGUMES">TRANSFORMATION
                                        ET
                                        CONSERVATION
                                        DE FRUITS ET LEGUMES</option>
                                    <option value="FABRICATION DE CORPS GRAS D'ORIGINE ANIMALE ET VEGETALE">FABRICATION
                                        DE
                                        CORPS
                                        GRAS
                                        D'ORIGINE ANIMALE ET VEGETALE</option>
                                    <option value="TRAVAIL DES GRAINS ; FABRICATION DE PRODUITS AMYLACES">TRAVAIL DES
                                        GRAINS
                                        ;
                                        FABRICATION DE PRODUITS AMYLACES</option>
                                    <option value="FABRICATION DE PRODUITS ALIMENTAIRES A BASE DE CEREALES N.C.A.">
                                        FABRICATION
                                        DE
                                        PRODUITS ALIMENTAIRES A BASE DE CEREALES N.C.A.</option>
                                    <option value="TRANSFORMATION DU CACAO ET DU CAFÉ">TRANSFORMATION DU CACAO ET DU
                                        CAFÉ
                                    </option>
                                    <option value="FABRICATION D'AUTRES PRODUITS ALIMENTAIRES">FABRICATION D'AUTRES
                                        PRODUITS
                                        ALIMENTAIRES</option>
                                    <option value="FABRICATION DE BOISSONS ALCOOLISÉES">FABRICATION DE BOISSONS
                                        ALCOOLISÉES
                                    </option>
                                    <option value="FABRICATION DE BOISSONS NON ALCOOLISES ET D'EAUX MINERALES">
                                        FABRICATION
                                        DE
                                        BOISSONS
                                        NON ALCOOLISES ET D'EAUX MINERALES</option>
                                    <option value="FABRICATION DE PRODUITS A BASE DE TABAC">FABRICATION DE PRODUITS A
                                        BASE
                                        DE
                                        TABAC
                                    </option>
                                    ...
                                    <option value="FABRICATION DE CHAUSSURES ET ARTICLES CHAUSSANTS">FABRICATION DE
                                        CHAUSSURES
                                        ET
                                        ARTICLES CHAUSSANTS</option>
                                    <option value="TRAVAIL DU BOIS">TRAVAIL DU BOIS</option>
                                    <option value="FABRICATION D'ARTICLES EN BOIS LIEGE VANNERIE ET SPARTERIE">
                                        FABRICATION
                                        D'ARTICLES EN
                                    ...
                                    <option value="IMPRIMERIE ET ACTIVITES CONNEXES">IMPRIMERIE ET ACTIVITES CONNEXES
                                    </option>
                                    <option value="REPRODUCTION D'ENREGISTREMENTS">REPRODUCTION D'ENREGISTREMENTS
                                    </option>
                                    <option value="RAFFINAGE DU PETROLE">RAFFINAGE DU PETROLE</option>
                                    <option value="COKEFACTION">COKEFACTION</option>
                                    <option value="FABRICATION DE PRODUITS CHIMIQUES DE BASE">FABRICATION DE PRODUITS
                                        CHIMIQUES
                                        DE
                                        BASE
                                    </option>
                                    <option value="FABRICATION DE PRODUITS CHIMIQUES FONCTIONNELS">FABRICATION DE
                                        PRODUITS
                                        CHIMIQUES
                                        FONCTIONNELS</option>
                                    ...
                                    <option value="FABRICATION DE VERRE ET D'ARTICLES EN VERRE">FABRICATION DE VERRE ET
                                        ...
                                        EN
                                        VERRE</option>
                                    <option value="FABRICATION DE PRODUITS CÉRAMIQUES">FABRICATION DE PRODUITS
                                        CÉRAMIQUES
                                    </option>
                                    <option value="FABRICATION DE CIMENTS ET AUTRES PRODUITS MINERAUX">FABRICATION DE
                                        CIMENTS ET
                                        AUTRES
                                        PRODUITS MINERAUX</option>
                                    <option
                                        value="FABRICATION DE COMPOSANTS ELECTRONIQUE D'ORDINATEURS ET DE PERIPHERIQUES">
                                        FABRICATION
                                    ...
                                    <option
                                        ...
                                        FABRICATION D'EQUIPEMENTS DE COMMUNICATION ET DE PRODUITS ELECTRONIQUES GRAND
                                        PUBLICS
                                    </option>
                                    <option
                                        value="FABRICATION D'EQUIPEMENTS D'IMAGERIE MEDICALE DE PRECISION D'OPTIQUE ET D'HORLOGERIE">
                                        FABRICATION D'EQUIPEMENTS D'IMAGERIE MEDICALE DE PRECISION D'OPTIQUE ET
                                        D'HORLOGERIE
                                    </option>
                                    <option value="FABRICATION DE MACHINES ET MATERIELS ELECTROTECHNIQUES">FABRICATION
                                        DE
                                        MACHINES
                                        ET
                                        MATERIELS ELECTROTECHNIQUES</option>
                                    <option value="FABRICATION D'AUTRES MATERIELS ELECTRIQUES">FABRICATION D'AUTRES
                                        MATERIELS
                                        ELECTRIQUES</option>
                                    <option value="CONSTRUCTION DE VÉHICULES AUTOMOBILES">CONSTRUCTION DE VÉHICULES
                                        AUTOMOBILES
                                    </option>
                                    <option value="CONSTRUCTION NAVALE AÉRONAUTIQUE ET FERROVIAIRE">CONSTRUCTION NAVALE
                                        AÉRONAUTIQUE ET
                                        FERROVIAIRE</option>
                                    <option value="FABRICATION DE MEUBLES ET MATELAS">FABRICATION DE MEUBLES ET MATELAS
                                    </option>
                                    ...
                                    <option value="INSTALLATION DE MACHINES ET D'EQUIPEMENTS PROFESSIONNELS">
                                        INSTALLATION
                                        DE
                                        MACHINES
                                        ET D'EQUIPEMENTS PROFESSIONNELS</option>
                                    <option value="PRODUCTION TRANSPORT ET DISTRIBUTION D'ÉLECTRICITÉ">PRODUCTION
                                        TRANSPORT
                                        ET
                                        DISTRIBUTION D'ÉLECTRICITÉ</option>
                                    <option value="PRODUCTION ET DISTRIBUTION DE COMBUSTIBLES GAZEUX ET DE GLACE">
                                        PRODUCTION ET
                                        DISTRIBUTION DE COMBUSTIBLES GAZEUX ET DE GLACE</option>
                                    <option value="CAPTAGE TRAITEMENT ET DISTRIBUTION D'EAU">CAPTAGE TRAITEMENT ET
                                        DISTRIBUTION
                                        D'EAU
                                    </option>
                                    <option value="COLLECTE ET TRAITEMENT DES EAUX USEES">COLLECTE ET TRAITEMENT DES
                                        EAUX
                                        USEES
                                    </option>
                                    <option value="COLLECTE TRAITEMENT ET ELIMINATION DES DECHETS ; RECUPERATION">
                                        COLLECTE
                                        TRAITEMENT
                                        ET ELIMINATION DES DECHETS ; RECUPERATION</option>
                                    <option value="DEPOLLUTION ET GESTION DES DECHETS">DEPOLLUTION ET GESTION DES
                                        DECHETS
                                    </option>
                                    <option value="PROMOTION IMMOBILIÈRE">PROMOTION IMMOBILIÈRE</option>
                                    <option value="CONSTRUCTION DE BÂTIMENTS COMPLETS">CONSTRUCTION DE BÂTIMENTS
                                        COMPLETS
                                    </option>
                                    ...
                                    <option value="ENTRETIEN ET REPARATION DE VEHICULES AUTOMOBILES">ENTRETIEN ET
                                        REPARATION DE
                                        VEHICULES AUTOMOBILES</option>
                                    <option value="COMMERCE DE PIECES DETACHEES ET D'ACCESSOIRES AUTOMOBILES">COMMERCE
                                        DE
                                        PIECES
                                        DETACHEES ET D'ACCESSOIRES AUTOMOBILES</option>
                                    <option value="COMMERCE ET RÉPARATION DE MOTOCYCLES">COMMERCE ET RÉPARATION DE
                                        MOTOCYCLES
                                    </option>
                            ...
                            <div class="w-full">
                                ...
                                <input wire:model="montant" type="number" id="montant"
                                    class="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition ease-in-out duration-200"
                                    placeholder="Entrez le montant" oninput="calculerTotal()">
                                @error('montant')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <input wire:model="taux" type="number" id="taux"
                                    class="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition ease-in-out duration-200"
                                    placeholder="Entrez le taux" oninput="calculerTotal()">
                                @error('taux')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <div class="flex space-x-4 mt-4" x-show="typeFinancement">
                                    ...
                                    <div x-show="typeFinancement === 'groupé'" class="flex flex-col flex-1 ">
                                        <label for="bailleur_groupé"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ciblez
                                            un
                                            type
                            ...
                            <div>
                                <label for="mode_recouvre" class="block text-sm font-medium text-gray-700">choissisez
                                    le
                                    mode
                                    de recouvrement
                                </label>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="relative">
                                                <label for="portionObligations"
                                                    class="block text-sm font-medium text-gray-700">Portion du
                                                    Financement
                                                    par Obligations (FCFA)</label>
                                                <input type="number" wire:model="portionObligations"
                                                    id="portionObligations"
                                                    class="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition ease-in-out duration-200"
                                                    placeholder="Entrez la portion en FCFA" oninput="calculerTotal()">

                                            </div>

                                            <!-- Portion du financement par Actions -->
                                            <div class="relative">
                                                <label for="prixAction"
                                                    class="block text-sm font-medium text-gray-700">Prix d'une action
                                                    (FCFA)</label>
                            ...
                            <div class="mt-4">
                                <div class="-my-3 divide-y divide-gray-200 dark:divide-gray-800">
                                    ...
                                    <dl class="flex items-center justify-between gap-4 py-3">
                                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Montant
                                            recherché</dt>
                                    ...
                                    <!-- Retour sur investissement / Taux d'intérêt -->
                                    <dl class="flex items-center justify-between gap-4 py-3">
                                    ...
                                    <!-- Montant du Projet Total -->
                                    <dl class="flex items-center justify-between gap-4 py-3">
                                        <dt class="text-base font-bold text-gray-900 dark:text-white">Montant du Projet
                                            Total</dt>
                                    ...
                                    <!-- Retour sur investissement / Taux d'intérêt -->
                                    <dl x-show="mode_recouvre === 'faO'"
                                        class="flex items-center justify-between gap-4 py-3">
                                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Somme
                                            restante
                                            en Action</dt>
                                        <dd class="text-base font-medium text-gray-900 dark:text-white"
                                            id="sommeaction">0
                                            FCFA</dd>
                                        <input type="hidden" name="sommeaction" id="somme_action" required>
                                    </dl>

                                    <!-- Nombre d'actions Total (facultatif) -->
                                    <dl x-show="mode_recouvre === 'faO'"
                                        class="flex items-center justify-between gap-4 py-3">
                                        <dt class="text-base font-bold text-gray-900 dark:text-white">Nombre d'actions
                                            Total</dt>
                                        <dd class="text-base font-bold text-purple-600 dark:text-white"
                                            id="nombreActions">0</dd>
                                        <input type="hidden" name="nombreActions" id="actions_total">
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div class="relative">
                                    ...
                                    @if (!$photo1)
                                        ...
                                        <label for="photo1"
                                            ...
                                            <span class="text-sm text-gray-600 mt-2">Cliquez ou déposez une
                                                photo</span>
                                        </label>
                                    @else
                                ...
                                <!-- Photo 2 -->
                                <div class="relative">
                                    <label for="photo2" class="block text-sm font-medium text-gray-700">Image
                                        2</label>
                                    @if (!$photo2)
                                        <label for="photo2"
                                            class="mt-1 flex flex-col items-center justify-center cursor-pointer border-2 border-dashed border-gray-300 rounded-md h-40 w-full hover:bg-gray-50">
                                ...
                                <!-- Photo 3 -->
                                <div class="relative">
                                    <label for="photo3" class="block text-sm font-medium text-gray-700">Image
                                        3</label>
                                ...
                                <!-- Photo 4 -->
                                <div class="relative">
                                    <label for="photo4" class="block text-sm font-medium text-gray-700">Image
                                        4</label>
                                    @if (!$photo4)
                                        <label for="photo4"
                                            class="mt-1 flex flex-col items-center justify-center cursor-pointer border-2 border-dashed border-gray-300 rounded-md h-40 w-full hover:bg-gray-50">
                                ...
                                <!-- Photo 5 -->
                                <div class="relative">
                                    <label for="photo5" class="block text-sm font-medium text-gray-700">Image
                                        5</label>
                                    @if (!$photo5)
                                        <label for="photo5"
                                            class="mt-1 flex flex-col items-center justify-center cursor-pointer border-2 border-dashed border-gray-300 rounded-md h-40 w-full hover:bg-gray-50">
