            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 p-3">
                ...
                <div>
                    ...
                    <select id="categorie" wire:model="categorie" required
                        ...
                        <option value="SYLVICULTURE ET EXPLOITATION FORESTIERE">SYLVICULTURE ET EXPLOITATION FORESTIERE
                        </option>
                        ...
                        <option value="EXTRACTION DE PIERRES DE SABLES ET D'ARGILES">EXTRACTION DE PIERRES DE SABLES ET
                            D'ARGILES</option>
                        ...
                        <option value="ACTIVITES DE SOUTIEN AUX AUTRES INDUSTRIES EXTRACTIVES">ACTIVITES DE SOUTIEN AUX
                            AUTRES INDUSTRIES EXTRACTIVES</option>
                        <option value="ABATTAGE TRANSFORMATION ET CONSERVATION DE LA VIANDE">ABATTAGE TRANSFORMATION ET
                        ...
                        <option value="FABRICATION DE PRODUITS ALIMENTAIRES A BASE DE CEREALES N.C.A.">FABRICATION DE
                        ...
                        <option value="FABRICATION DE PRODUITS A BASE DE TABAC">FABRICATION DE PRODUITS A BASE DE TABAC
                        </option>
                        <option value="FILATURE TISSAGE ET ENNOBLISSEMENT DE TEXTILE">FILATURE TISSAGE ET ENNOBLISSEMENT
                            DE
                            TEXTILE</option>
                        <option value="FABRICATION D'AUTRES ARTICLES TEXTILES">FABRICATION D'AUTRES ARTICLES TEXTILES
                        </option>
                        ...
                        <option value="TRAVAIL DU CUIR; FABRICATION D'ARTICLES DE VOYAGE">TRAVAIL DU CUIR; FABRICATION
                            D'ARTICLES DE VOYAGE</option>
                        <option value="FABRICATION DE CHAUSSURES ET ARTICLES CHAUSSANTS">FABRICATION DE CHAUSSURES ET
                        ...
                        <option value="FABRICATION DE PAPIER CARTONS ET D’ARTICLES EN PAPIER OU EN CARTON">FABRICATION
                            DE
                        ...
                        <option value="FABRICATION DE PRODUITS CHIMIQUES DE BASE">FABRICATION DE PRODUITS CHIMIQUES DE
                            BASE
                        </option>
                        <option value="FABRICATION DE PRODUITS CHIMIQUES FONCTIONNELS">FABRICATION DE PRODUITS CHIMIQUES
                            FONCTIONNELS</option>
                        <option value="FABRICATION DE PRODUITS PHARMACEUTIQUES">FABRICATION DE PRODUITS PHARMACEUTIQUES
                        </option>
                        ...
                        <option value="FABRICATION DE VERRE ET D'ARTICLES EN VERRE">FABRICATION DE VERRE ET D'ARTICLES
                            EN
                            VERRE</option>
                        ...
                        <option value="FABRICATION DE MACHINES ET MATERIELS ELECTROTECHNIQUES">FABRICATION DE MACHINES
                            ET
                        ...
                        <option value="REPARATION DE MACHINES ET D'EQUIPEMENTS PROFESSIONNELS">REPARATION DE MACHINES
                            ET
                        ...
                        <option value="ACTIVITÉS SPECIALISEES DE CONSTRUCTION">ACTIVITÉS SPECIALISEES DE CONSTRUCTION
                        </option>
                        ...
                        <option value="COMMERCE DE PIECES DETACHEES ET D'ACCESSOIRES AUTOMOBILES">COMMERCE DE PIECES
