<div>
    ...
    <x-negociation-card name="DETAILS DE LA DEMANDE DE CREDIT" mot='bas' :lastActivity="$lastActivity" :nombreParticipants="$nombreParticipants"
    ...
    <div class="flex flex-col md:flex-row mb-8 w-full overflow-hidden">
        ...
        @else
            @include('finance.components.demande-credit-directe')
