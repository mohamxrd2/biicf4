        ...
        <form wire:submit.prevent="submit" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select x-model="type" class="w-full p-2 border border-gray-300 rounded-md">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" class="w-full p-2 border border-gray-300 rounded-md" placeholder="Tapez ici...">
                </div>
            </div>
            ...
            <div x-show="type === 'Service'" class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
