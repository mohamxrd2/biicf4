        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('countdownTimer', (projetDurer) => ({
                ...
                init() {
                    ...
                    Echo.channel('debut-negociation')
                        .listen('DebutDeNegociation', (e) => {
                            console.log('Événement DebutDeNegociation reçu', e);
                            // Ici, vous pouvez vérifier d'autres propriétés que vous avez envoyées avec l'événement
                            // Par exemple, si vous avez envoyé la date ou d'autres informations, modifiez la condition ici
