    ...
    <div class="overflow-hidden bg-white rounded-lg shadow-md">
        <div class="p-6 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-800">
                Détails de la commande après négociation
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        <strong>Lieu de livraison :</strong> {{ $appeloffre->localite }}
                                    </p>
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">
                                        <strong>Quantité demandée :</strong> {{ $appeloffre->quantity }}
                                    </p>
                                    <p class="mt-1 text-sm text-gray-600">
                                        <strong>Prix Unitaire( apres negociation) :</strong>
                                        {{ $this->notification->data['prixTrade'] }} FCFA
                                    </p>
                                </div>
