                        ...
                        @switch($type)
                            ...
                            @case('App\Notifications\OffreNegosDone')
                                @include('biicf.components.ConfirmationNotif', [
                                    ...
                                    'description' =>
                                        $notification->data['description'] ?? 'Description indisponible',
                                    'orderId' => $notification->data['code_unique'] ?? 'N/A',
                            ...
                            @case('App\Notifications\OffreNotif')
                                @include('biicf.components.OffreNotif', [
                                    ...
                                    'svg' =>
                                        '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-green-600"> <path stroke-linecap="round" stroke-linejoin="round"d="M20.25 7.5l-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5m8.25 3v6.75m0 0-3-3m3 3 3-3M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" /> </svg>',
                                    'markAsRead' => true,
                                    'delete' => true,
                                ])
                            @break
                            ...
                            @default
                                <div class="p-4 text-gray-600">
                                    Type de notification non géré : {{ $type }}
                                </div>
                        @endswitch
                        @empty
                            <div class="p-8 flex flex-col items-center justify-center bg-gray-50 rounded-lg shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-16 h-16 text-gray-500 mb-4">
                                    <path stroke-linecap="round" stroke-linejoin="round"
