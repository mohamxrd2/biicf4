<div wire:poll.10ms>
    ...
    @forelse ($transactions as $transaction)
                ...
                <div class="w-full max-w-lg p-6 mx-4 bg-white rounded-lg shadow-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-semibold text-gray-900">{{ strtoupper($transaction->senderAdmin->name ?? 'Admin') }}</span>
                        </div>
        ...
        <!-- Bouton Voir plus, uniquement si il y a plus de transactions à charger -->
        ...
        <div class="mt-6 flex justify-center">
            <button wire:click="loadMore" wire:loading.attr="disabled"
                ...
                <!-- Le texte "Voir plus" disparaît et est remplacé par "Chargement..." pendant le chargement -->
                <span>Voir plus</span>
