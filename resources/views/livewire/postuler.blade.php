<div wire:poll.15000ms>
    @if ($livraison)
        <div class="mb-6 p-4 ">
            <h2 class="text-xl font-semibold text-center text-gray-700 mb-4">Suivi de la demande pour etre livreur</h2>
  ...
  @if($psap)  
  <div class="mb-6 p-4 ">
    <h2 class="text-xl font-semibold text-center text-gray-700 mb-4">Suivi de la demande pour etre PSAP</h2>
    <div class="flex items-center space-x-4">
        <div class="flex-1">
            <div class="relative">
                <div class="w-full h-2 bg-gray-200 rounded-full">
