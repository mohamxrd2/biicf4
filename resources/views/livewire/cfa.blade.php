<div>
    <div class="container py-4 ">
        ...
        <div class="container mx-auto py-4">
            ...
            <div class="flex items-center justify-between bg-blue-300 shadow-md p-6 rounded-lg">
            ...
            <table class="min-w-full bg-white">
                <thead>
                    <tr class="w-full bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Raison du credit</th>
                ...
                <tbody class="text-gray-600 text-base font-semibold tracking-wide">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left">Achat</td>
