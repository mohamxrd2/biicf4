<div class="max-w-5xl mx-auto">
    <x-negociation-card name="NÉGOCIATION POUR L'APPEL OFFRE GROUPER" mot='bas' :lastActivity="$lastActivity" :nombreParticipants="$nombreParticipants"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                <h1 class="text-2xl font-bold text-gray-800 mb-3">{{ $appeloffregrp->product_name }}
                                </h1>
                                    ...
                                    @php
                                        $specifications = [
                                            ...
                                            'Date de récupération' =>
                                                isset($appeloffregrp->dateTot) && isset($appeloffregrp->dateTard)
    ...
    <script>
        function checkPrice() {
            ...
            const lowestPrice = parseFloat({{ $appeloffregrp->lowestPricedProduct }});
