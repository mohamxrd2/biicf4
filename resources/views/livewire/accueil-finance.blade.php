        ...
        <div class="flex flex-col md:flex-row mb-8 w-full overflow-hidden">
            ...
            <div class="md:px-4 flex flex-col w-full md:w-1/2 py-4">
                ...
                <div class="flex items-center mb-2">
                    ...
                    <span class="ml-2 text-sm text-gray-500">{{ $projetRecent->categorie }}</span>
                </div>
                ...
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-600 mt-2">
                            {{ \Illuminate\Support\Str::words($projet->description, 15, '...') }} <!-- Affiche les 100 premiers mots de la description -->
                        </p>
                        ...
                        <div class="flex py-2 mt-2 items-center">
                            ...
                            <div class="ml-2 text-sm font-semibold">
                                <span class="font-medium text-gray-500 mr-2">De</span>{{ $projet->demandeur->name }} <!-- Nom du demandeur -->
                            </div>
                        </div>
                    </div>
                </div>
