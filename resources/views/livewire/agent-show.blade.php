<div>
    <div
        class="w-full flex justify-between items-center p-6 bg-gray-50 border border-gray-200 rounded-lg  dark:bg-neutral-800">
    ...
    <div class="grid grid-cols-3 gap-4 my-4">
        ...
        <div class="lg:col-span-1 col-span-3  ">
            <div class="flex flex-col p-4 bg-gray-50 border border-gray-200 rounded-md">
                ...
                <a href="#" class="w-full  text-red-800 bg-red-100 rounded-md text-center p-1 ">
                    Supprimé l'agent
