        ...
        <div class="max-w-4xl mx-auto mb-8">
            <div class="bg-white rounded-2xl shadow-xl p-8 transform hover:scale-[1.01] transition-all duration-300">
                <div class="text-center">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Paiement Réussi !</h2>
                    <p class="text-lg text-gray-600 mb-8">Votre paiement a été traité avec succès. Merci pour votre
                        confiance !</p>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                        <div class="bg-gray-50 rounded-xl p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">Détails de la Transaction</h3>
                            <ul class="space-y-3">
                        ...
                        <div class="bg-gray-50 rounded-xl p-6">
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-600">Un email de confirmation vous sera envoyé</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                    ...
                                    <span class="text-gray-600">Vous pouvez suivre votre commande dans votre espace
                                        personnel</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <form wire:submit.prevent="verifyCode" class="space-y-6">
                        ...
                        @if (session()->has('succes'))
                            <button wire:click="toggleComponent"
                                class="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
                                <span class="text-white">Payement & Main levée</span>
                            </button>
                        @else
