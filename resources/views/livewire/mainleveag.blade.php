<div>
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="bg-gray-100 p-4 rounded-lg">
            <p class="mb-2">Nom du fournisseur: <span class="font-semibold">{{ $namefourlivr->user->name }}</span>
            </p>
            <p class="mb-2">Adresse du fournisseur: <span
                    class="font-semibold">{{ $namefourlivr->user->address }}</span>
            </p>
            <p class="mb-2">Email du founisseur: <span class="font-semibold">{{ $namefourlivr->user->email }}</span>
            </p>
    ...
    <div class="max-w-4xl mt-6 flex">
        ...
        @else
            <button wire:click='mainleve' class="p-2 flex text-white font-medium bg-green-700 rounded-md mr-4"><svg
