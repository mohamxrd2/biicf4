        ...
        <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl w-full bg-white shadow-lg rounded-xl p-8">
                ...
                <div class="flex items-center justify-between border-b pb-4">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">Détails de la commande(appeloffre)</h1>
                        <p class="mt-1 text-sm text-gray-500">Commande
                            #{{ $notification->data['code_unique'] ?? $appeloffre->code }}</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    ...
                    <div class="p-4 bg-gray-50 rounded-lg shadow-inner">
                        ...
                        <div class="mt-2 text-sm text-gray-600 space-y-1">
                            <p><span class="font-medium">Nom : </span>{{ $appeloffre->user->name }}</p>
                            <p><span class="font-medium">Email : </span>{{ $appeloffre->user->email }}</p>
                            <p><span class="font-medium">Téléphone : </span>{{ $appeloffre->user->phone }}</p>
                        </div>
                    </div>
                    @if ($notification->reponse == 'accepter')
                        ...
                        <div class="p-4 bg-gray-50 rounded-lg shadow-inner">
                            ...
                            <div class="mt-2 text-sm text-gray-600 space-y-1">
                                <p><span class="font-medium">Nom : </span>{{ $appeloffre->user->name }}</p>
                                <p><span class="font-medium">Email : </span>{{ $appeloffre->user->email }}</p>
                                <p><span class="font-medium">Téléphone : </span>{{ $appeloffre->user->phone }}
                                </p>
                                <p><span class="font-medium">Adresse : </span>{{ $appeloffre->user->commune }}
                                </p>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="mt-4 flex items-center bg-gray-50 p-4 rounded-lg shadow-inner">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="mt-1 text-sm text-gray-600">Quantité commandée:
                                {{ $appeloffre->quantity }}({{ $produit->condProd }})</p>
                            <p class="mt-1 text-sm text-gray-600">Prix unitaire au debat: {{ $produit->prix }} FCFA</p>
                            <p class="mt-1 text-sm text-gray-600">Prix unitaire apres negociation : {{ $appeloffre->lowestPricedProduct }} FCFA</p>
                        </div>
                        <div class="text-sm font-medium text-gray-900">
                            {{ number_format($appeloffre->montant_total, 2, ',', '.') }} FCFA
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-4 bg-gray-50 p-4 rounded-lg shadow-inner space-y-3">
                        <div class="flex justify-between text-sm text-gray-600">
                            ...
                            <span>{{ number_format($appeloffre->montant_total, 2, ',', '.') }}
                                FCFA</span>
                        </div>
                        <div class="flex justify-between text-sm text-gray-600">
                        ...
                        <div class="flex justify-between font-medium text-gray-900">
                            <span>Total :</span>
                            <span>{{ number_format($appeloffre->montant_total + $notification->data['prixTrade'], 2, ',', '.') }}
                                FCFA</span>
                        </div>
                    </div>
                </div>
