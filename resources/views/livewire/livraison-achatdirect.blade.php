                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-6">
                                ...
                                <ul class="space-y-4">
                                    @php
                                        $specifications = [
                                            'Quantité' => $achatdirect->quantité . ' unités',
                                            'Conditionnement' => $notification->data['textareaContent'],
                                            'Lieu de livraison' => $achatdirect->localite,
                                            'Date de récupération' =>
                                                isset($achatdirect->dateTot) && isset($achatdirect->dateTard)
                                                    ? "{$achatdirect->dateTot} - {$achatdirect->dateTard}"
                                                    : 'Non spécifiée',
                                            'Lieu de récupération' => implode(', ', [
