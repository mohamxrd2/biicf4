                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div>
                            <img class="h-auto max-w-full rounded-lg"
                                src="{{ asset('post/all/' . $produit->photoProd1) }}" alt="">
                        </div>
                        <div>
                            <img class="h-auto max-w-full rounded-lg"
                                src="{{ asset('post/all/' . $produit->photoProd2) }}" alt="">
                        </div>
                        <div>
                            <img class="h-auto max-w-full rounded-lg"
                                src="{{ asset('post/all/' . $produit->photoProd3) }}" alt="">
                        </div>
                        <div>
                            <img class="h-auto max-w-full rounded-lg"
                                src="{{ asset('post/all/' . $produit->photoProd4) }}" alt="">
                        </div>
                    </div>
                @endif
                <a href="{{ route('biicf.postdet', $notification->data['idProd']) }}"
