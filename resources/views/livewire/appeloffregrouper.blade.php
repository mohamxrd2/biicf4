<div>
    <!-- Conteneur principal -->
    <class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg">
    <!-- Section de titre et compte à rebours -->
    <div class="flex justify-between items-center mb-8">
        <h2 class="text-3xl font-bold text-gray-800">Ajout de Quantités</h2>

        <!-- Compte à rebours -->
        <div id="countdown-container" x-data="countdownTimer({{ json_encode($datePlusAncienne) }})" class="flex items-center justify-center space-x-4">
                ...
                <div
                    ...
                    <span class="text-gray-700 font-medium flex items-center space-x-2">
                        ...
                        <span>{{ $groupage->user->name ?? 'Utilisateur inconnu' }} - {{ $groupage->quantite }}
                            (unités) - {{ $groupage->quantite * $appelOffreGroup->lowestPricedProduct}} FCFA
                        </span>
                    </span>
