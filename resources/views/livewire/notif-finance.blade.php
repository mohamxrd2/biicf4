                            ...
                            <div class="flex flex-wrap items-center gap-y-4 py-6">
                                ...
                                <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1 ml-3">
                                    ...
                                    @if ($notification->reponse == 'approved')
                                        <dd
                                            class="me-2 mt-1.5 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-yellow-900 dark:text-yellow-300">
