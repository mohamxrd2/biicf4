...
return new class extends Migration
{
    ...
    {
        Schema::create('projets_accordés', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('montan_restantt', 10, 2); // Montant du crédit
            $table->integer('action'); // Montant du crédit
            ...
            $table->string('statut')->default('en cours'); // Statut du crédit (en_cours, terminé, annulé)
    ...
    {
        Schema::dropIfExists('projets_accordés');
    }
};
